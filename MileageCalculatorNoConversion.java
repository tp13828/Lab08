/**
 * File Name: MileageCalculatorNoConversion.java
 * Class: CSCI 1302
...
public class MileageCalculatorNoConversion extends Application {
	...
	private String[] selection = { "MPG", "L/100 KM" };
	...
	public void start(Stage primaryStage) {
		...
		ObservableList<String> items = FXCollections.observableArrayList(selection);
